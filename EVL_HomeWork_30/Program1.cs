...
namespace EVL_HomeWork_30
{
    ...
    class RepoPlayers
    {
        ...
        public void AddPlayer()
        {
            ...
            isFindPlayer = _players.Exists(findPlayer => findPlayer.Number == numberPlayer);
            if (isFindPlayer)
            {
        ...
        public void DeletePlayer(int id)
        {
            ...
            isFindPlayer = _players.Exists(findPlayer => findPlayer.Number == id);
            if (isFindPlayer)
            {
        ...
        public void SetBan(int id, bool flag)
        {
            if (CheckQuantity()) return;
